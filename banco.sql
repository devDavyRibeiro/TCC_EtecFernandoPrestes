...
VALUES
    (
        ...
        'chiovetto@gmail.com',
        '123456789',
        'Rua Comendador Vicente do Amaral',
        '0',
        '$2a$08$CflfllePArKlBJomMOF6a.JApjuTgn84RmWIijESLx7r4Pa4CWg3W',
        '2',
        'admin'
    );
...
VALUES
    (
        ...
        'Rua Comendador Vicente do Amaral',
        '0',
        '$2a$08$CflfllePArKlBJomMOF6a.EmZaNGdstz6Y76f.0I8cC4B3QpnE81q',
        '1',
        'Orçamento'
    );
...
VALUES
    (
        ...
        'Rua Encomendador',
        '1',
        '$2a$08$CflfllePArKlBJomMOF6a.GgvxvDpCtKmWBUensmqy3wwBpaAq7/W'
    );
...
-- 123123
INSERT INTO
    `Produtos` (`nome_produto`, `valor_produto`, `foto_produto`)
VALUES
    ('Balcão de cozinha', '100', 'balcao1.jpg');

INSERT INTO
    `Produtos` (`nome_produto`, `valor_produto`, `foto_produto`)
VALUES
    ('Balcão pia claro', '150', 'balcao2.jpg');

INSERT INTO
    `Produtos` (`nome_produto`, `valor_produto`, `foto_produto`)
VALUES
    ('Balcão pia escuro', '175', 'balcao3.jpg');

INSERT INTO
    `Produtos` (`nome_produto`, `valor_produto`, `foto_produto`)
VALUES
    ('Cuba de banheiro', '125', 'banheiro1.jpg');

INSERT INTO
    `Produtos` (`nome_produto`, `valor_produto`, `foto_produto`)
VALUES
    ('Cuba branca', '140', 'banheiro2.jpg');

INSERT INTO
    `Produtos` (`nome_produto`, `valor_produto`, `foto_produto`)
VALUES
    ('Cuba bege', '210', 'banheiro3.jpg');

INSERT INTO
    `Produtos` (`nome_produto`, `valor_produto`, `foto_produto`)
VALUES
    ('Pia escura', '120', 'slide1.jpg');

INSERT INTO
    `Produtos` (`nome_produto`, `valor_produto`, `foto_produto`)
VALUES
    ('Pia grande', '135', 'slide2.jpg');

INSERT INTO
    `Produtos` (`nome_produto`, `valor_produto`, `foto_produto`)
VALUES
    ('Pia moderna', '168', 'slide3.jpg');
